+++
date = "2016-12-28T16:25:17+08:00"
title = "vim 快捷键"
categories = ["技术"]
tags = ["vim"]
Description = "vim 快捷键总结"
...
10. [分屏编辑 ](#vim10)
	...
	* 10.3 [关闭子窗口 ](#vim10.3)
	* 10.4 [调整窗口大小 ](#vim10.4)
	* 10.5 [切换和移动窗口 ](#vim10.5)
11. [快速编辑 ](#vim11)
	* 11.1 [改变大小写 ](#vim11.1)
	* 11.2 [替换（normal模式）](#vim11.2)
	* 11.3 [撤消与重做（normal模式） ](#vim11.3)
	* 11.4 [宏 ](#vim11.4)
12. [编辑特殊文件 ](#vim12)
	* 12.1 [文件加解密 ](#vim12.1)
	* 12.2 [文件的编码 ](#vim12.2)
...
13. [编程辅助 ](#vim13)
	...
	* 13.9 [多行缩进缩出 ](#vim13.9)
14. [命令行 ](#vim14)
	* 14.1 [命令行模式下的快捷键 ](#vim14.1)
	* 14.2 [执行外部命令 ](#vim14.2)
15. [其它 ](#vim15)
	* 15.1 [工作目录 ](#vim15.1)
	* 15.2 [一些快捷键（收集中）](#vim15.2) 
	* 15.3 [在线帮助 ](#vim15.3)
	* 15.4 [一些小功能 ](#vim15.4)
...
#### vim11.2 11.2 替换（normal模式）

r: 替换光标处的字符，同样支持汉字。
R: 进入替换模式，按esc回到正常模式。

#### vim11.3 11.3 撤消与重做（normal模式）
